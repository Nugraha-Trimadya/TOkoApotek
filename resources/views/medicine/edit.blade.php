...
@section('content')
    ...
    <div class="container">
        <h1>Halaman Data Obat</h1>
        <div class="card p-5">
            <form action="{{ route('obat.edit_formulir' , $medicine['id']) }}" method="POST">
                {{--
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="type" name="type">
                            ...
                            <option value="sirup" {{ $medicine['type'] == 'kapsul' ? 'selected' : '' }}>Sirup</option>
                            <option value="kapsul"  {{ $medicine['type'] == 'sirup' ? 'selected' : '' }}>Kapsul</option>
                        </select>
                    </div>
                </div>
                <div class="mb-3 row">
